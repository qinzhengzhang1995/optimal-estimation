...
for xinzao in range(-20, -5+1, 5):
    for hunxiang in range(20,61,10):
    # for hunxiang in range(20, 71, 10):
        ...
        # for jiaodu in range(2, 13, 1):
            ...
            for frequency in range(3):
                ...
                model_name = os.path.join('SPP_containrever_highsame_noweightdecay_-5_%dfrequency_%depoch' % (frequency, 50))
            ...
            h5f = h5py.File('G:\\SPP_contain_rever\\result_small_use14\\result_IRM_contain_rever_%ddb_0%d_ang%d.h5' % (xinzao, hunxiang, jiaodu), 'w')
