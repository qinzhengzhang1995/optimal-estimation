...
SNR = -15
hunxiangjishu = 0
for hunxiangwenjianming = 30:20:50
hunxiangjishu = hunxiangjishu+1;
yongjuzhenbiaoda = 0;
for xuanzejiaodu = 2:12
    xuanzejiaodu
    yongjuzhenbiaoda = yongjuzhenbiaoda + 1;
        filename = ['D:\SPP_contain_rever_changeroomsize\data\SPP_contain_rever\' 'y_' num2str(SNR) 'db_0' num2str(hunxiangwenjianming) '_noise92_100_05s_ang' num2str(xuanzejiaodu) '.mat'];
        load(filename);
        filename2=['D:\SPP_contain_rever_changeroomsize\data\SPP_contain_rever\result\' 'result_IRM_contain_rever_' num2str(SNR) 'db_0' num2str(hunxiangwenjianming) '_ang' num2str(xuanzejiaodu) '.h5'];
