...
for frequency in range(0,3,1):
    ...
    #####读取train
    list_title_train = os.listdir('/home/create.aau.dk/su41my/SPP_contain_rever_SER/train_highsame')
    url_train = '/home/create.aau.dk/su41my/SPP_contain_rever_SER/train_highsame/'
    type1 = 'x_train'
    ...
    list_title_test = os.listdir('/home/create.aau.dk/su41my/SPP_contain_rever_SER/test_highsame')
    url_test = '/home/create.aau.dk/su41my/SPP_contain_rever_SER/test_highsame/'
    type4 = 'x_test'
    ...
    # 网络测试
        ...
        with torch.no_grad():
            ...
            if epoch % 5 == 0:
                model_name = os.path.join('SPP_containrever_highsame_noweightdecay_-5_%dfrequency_%depoch'%(frequency,epoch))
