    ...
    # for hunxiang in range(20, 71, 10):
        ...
        # for jiaodu in range(2, 13, 1):
            ...
            for frequency in range(3):
                ...
                #     lun=40
                lun=40
                model_name = os.path.join('SPP_containrever_highsame_noweightdecay_-5_%dfrequency_%depoch' % (frequency, lun))
            ...
            h5f = h5py.File('G:\\SPP_contain_rever\\OMLSA\\result_SPP_contain_rever_and_NOISEPSD_%ddb_0%d_ang%d.h5' % (xinzao, hunxiang, jiaodu), 'w')
